...
class EnvTagsReplacer {
  ...
  replaceEnvTags(config, options={ }){
    ...
    try {
              ...
              case CONSTANTS.NUMBER:
                if (value.match(numberRegx)) {
                  ...
                  if (displayLogs) {
                    ...
                    this.writeConsoleLog(CONSTANTS.LOGGING.LOG, { component: CONSOLE_LOG_TAG_COMP }, err);
                  }
                }
                break;
      ...
      if ( displayLogs ) {
        this.writeConsoleLog(CONSTANTS.LOGGING.LOG,{component: CONSOLE_LOG_TAG_COMP},'Error in replacing env tags in the config', err)
      }
    }
    return config;
  }
